                    ...
                    case "luu":
                        {
                            ...
                            try
                            {
                                ...
                                dt.Load(SqlHelper.ExecuteReader(Commons.IConnections.CNStr, "spUpdateNGAY_NGHI_LE", (AddEdit ? 1 : 0), NGAYDateEdit.EditValue, LY_DOTextEdit.EditValue.ToString(), (txtSTT.EditValue == null) ? 0 : txtSTT.EditValue));
