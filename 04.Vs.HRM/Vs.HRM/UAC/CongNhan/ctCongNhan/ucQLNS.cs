                    ...
                    case "NB":
                        {
                            ...
                            btn8.Visible = false;
                            lbl8.Visible = false;
                            lbl4.Text = "Nghỉ sẩy thai";
                            lbl5.Text = "Nghỉ thai sản";
                            lbl6.Text = "Đã nghỉ việc";
                            lbl3.Text = "Nghỉ không lương";
                            btn7.Visible = false;
                            lbl7.Visible = false;
                            break;
                        }
                    case "NC":
                        {
                            ...
                            btn8.Visible = false;
                            lbl8.Visible = false;
                            lbl4.Text = "Nghỉ sẩy thai đình chỉ thai";
                            lbl5.Text = "Nghỉ thai sản";
                            lbl6.Text = "Đã nghỉ việc";
                            lbl3.Text = "Nghỉ không lương";
                            btn7.Visible = false;
                    ...
                    case "DM":
                        {
                            ...
                            btn1.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[0]["MAU_TT"].ToString());
                            btn3.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[1]["MAU_TT"].ToString());
                            btn4.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[2]["MAU_TT"].ToString());
                            btn5.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[3]["MAU_TT"].ToString());
                            btn6.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[4]["MAU_TT"].ToString());
                            btn7.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[5]["MAU_TT"].ToString());
                            btn8.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[6]["MAU_TT"].ToString());
                            btn2.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[7]["MAU_TT"].ToString());
                            break;
                        }
                    default:
                        {
                            ...
                            btn5.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[3]["MAU_TT"].ToString());
                            btn6.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[4]["MAU_TT"].ToString());
                            btn2.BackColor = System.Drawing.ColorTranslator.FromHtml(dt.Rows[5]["MAU_TT"].ToString());
                            break;
                        }
                }
            }
