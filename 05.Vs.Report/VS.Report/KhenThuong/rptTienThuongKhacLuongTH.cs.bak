...
namespace Vs.Report
{
    public partial class rptTienThuongKhacLuongTH : DevExpress.XtraReports.UI.XtraReport
    {
       
        public rptTienThuongKhacLuongTH(DateTime ngayIn, DateTime TuNgay)
        {
            InitializeComponent();
            Commons.Modules.ObjSystems.ThayDoiNN(this);
            NONlbGiaiDoan.Text = "Ngày " + TuNgay.ToString("dd/MM/yyyy");
