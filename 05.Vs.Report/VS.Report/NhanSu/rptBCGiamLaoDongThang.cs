...
namespace Vs.Report
{
    public partial class rptBCGiamLaoDongThang : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCGiamLaoDongThang(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
