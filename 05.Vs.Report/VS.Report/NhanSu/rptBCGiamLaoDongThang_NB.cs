...
namespace Vs.Report
{
    public partial class rptBCGiamLaoDongThang_NB : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCGiamLaoDongThang_NB(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
