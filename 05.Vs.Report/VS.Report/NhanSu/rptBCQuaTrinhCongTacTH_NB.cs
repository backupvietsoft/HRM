...
namespace Vs.Report
{
    public partial class rptBCQuaTrinhCongTacTH_NB : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCQuaTrinhCongTacTH_NB(DateTime ngayin,DateTime tuNgay, DateTime denNgay)
        {
        ...
        {
            ExpressionBinding expressionBinding = new ExpressionBinding("BeforePrint", "Tag", "ToStr([CN.MS_THE_CC])");
