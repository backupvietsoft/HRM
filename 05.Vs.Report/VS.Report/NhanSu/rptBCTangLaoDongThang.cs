...
namespace Vs.Report
{
    public partial class rptBCTangLaoDongThang : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCTangLaoDongThang(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
