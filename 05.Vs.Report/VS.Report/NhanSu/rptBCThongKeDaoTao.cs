...
namespace Vs.Report
{
    public partial class rptBCThongKeDaoTao : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCThongKeDaoTao(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
