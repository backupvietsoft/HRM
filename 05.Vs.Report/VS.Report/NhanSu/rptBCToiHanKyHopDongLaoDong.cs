...
namespace Vs.Report
{
    public partial class rptBCToiHanKyHopDongLaoDong : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCToiHanKyHopDongLaoDong(DateTime ngayin, String sTitle, DateTime TuNgay, DateTime DenNgay)
        {
