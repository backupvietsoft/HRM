...
namespace Vs.Report
{
    public partial class rptDSCBNVDieuChuyen : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDSCBNVDieuChuyen(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
