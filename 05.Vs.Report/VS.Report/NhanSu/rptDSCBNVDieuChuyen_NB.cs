...
namespace Vs.Report
{
    public partial class rptDSCBNVDieuChuyen_NB : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDSCBNVDieuChuyen_NB(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
