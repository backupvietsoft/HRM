...
namespace Vs.Report
{
    public partial class rptHopDongThuViec_CNQC : DevExpress.XtraReports.UI.XtraReport
    {
        public rptHopDongThuViec_CNQC(DateTime ngayin)
        {   //DateTime ngayin
            InitializeComponent();
            ...
            lbNgay.Text = "Hôm nay, ngày " + NgayBC.Substring(NgayBC.Length - 2, 2) + " tháng " + ThangBC.Substring(ThangBC.Length - 2, 2) + " năm " + NamBC.Substring(NamBC.Length - 4, 4) + ", tại văn phòng";
        }
