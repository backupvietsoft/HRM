...
namespace Vs.Report
{
    public partial class srptToKhaiBaoHiemXaHoi : DevExpress.XtraReports.UI.XtraReport
    {
        public srptToKhaiBaoHiemXaHoi(DateTime ngayin)
        {
            InitializeComponent();
            this.Tag = "srptToKhaiBaoHiemXaHoi";
            this.Name = "srptToKhaiBaoHiemXaHoi";
