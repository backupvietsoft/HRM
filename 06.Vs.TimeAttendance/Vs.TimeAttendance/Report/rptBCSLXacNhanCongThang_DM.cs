...
namespace Vs.Report
{
    public partial class rptBCSLXacNhanCongThang_DM : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCSLXacNhanCongThang_DM(DateTime datTngay, DateTime datDNgay,DateTime ngayin, string sTieuDe)
        {
            InitializeComponent();
            this.Tag = "rptBCSLXacNhanCongThang_DM";
