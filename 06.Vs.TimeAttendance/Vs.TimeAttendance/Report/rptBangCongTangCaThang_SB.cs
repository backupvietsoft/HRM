...
namespace Vs.Report
{
    public partial class rptBangCongTangCaThang_SB : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBangCongTangCaThang_SB(string TieuDe, DateTime ngayin, DateTime TNgay, DateTime DNgay)
        {
            InitializeComponent();
