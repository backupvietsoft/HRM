...
namespace Vs.Report
{
    public partial class rptBangCongTongHopThang_SB : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBangCongTongHopThang_SB(string TieuDe, DateTime ngayin, DateTime TNgay, DateTime DNgay)
        {
            InitializeComponent();
