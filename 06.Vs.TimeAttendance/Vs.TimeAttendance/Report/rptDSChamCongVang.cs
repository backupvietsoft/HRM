...
namespace Vs.Report
{
    public partial class rptDSChamCongVang : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDSChamCongVang(DateTime tngay, DateTime dngay, DateTime ngayin,string tieude)
        {
