...
{
    public partial class rptDanhSachTienPPhep : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDanhSachTienPPhep(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
