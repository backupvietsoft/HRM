                            ...
                            case 1:
                                {
                                  ...
                                  //  string sTieuDe = "DANH SÁCH THAY ĐỔI LƯƠNG " + Convert.ToString(txtThang.EditValue);
                                    ...
                                    frm1.rpt = new rptDSNhanVienThayDoiLuongGD(lk_NgayIn.DateTime, dTuNgay.DateTime,dDenNgay.DateTime);
                            ...
                            case 2:
                                {
                                   ...
                                   // string sTieuDe2 = "QUÁ TRÌNH LƯƠNG NHÂN VIÊN " + Convert.ToString(txtThang.EditValue);
                                    ...
                                    frmViewReport frm2 = new frmViewReport();
                                    frm2.rpt = new rptBCQuaTrinhLuongTH(lk_NgayIn.DateTime, dTuNgay.DateTime, dDenNgay.DateTime);
