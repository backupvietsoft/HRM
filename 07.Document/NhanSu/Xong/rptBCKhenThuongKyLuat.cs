...
namespace Vs.Report
{
    public partial class rptBCKhenThuongKyLuat : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCKhenThuongKyLuat(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
