...
namespace Vs.Report
{
    public partial class rptBCKhenThuongKyLuatBP : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCKhenThuongKyLuatBP(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
