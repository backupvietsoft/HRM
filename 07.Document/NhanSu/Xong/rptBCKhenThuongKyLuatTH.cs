...
namespace Vs.Report
{
    public partial class rptBCKhenThuongKyLuatTH : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCKhenThuongKyLuatTH(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
