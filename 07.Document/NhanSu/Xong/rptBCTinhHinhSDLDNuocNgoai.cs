...
namespace Vs.Report
{
    public partial class rptBCTinhHinhSDLDNuocNgoai : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBCTinhHinhSDLDNuocNgoai(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
