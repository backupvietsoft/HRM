...
namespace Vs.Report
{
    public partial class rptBangLuongThangNhanVien : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBangLuongThangNhanVien(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
