...
namespace Vs.Report
{
    public partial class rptDSCBNBDieuChuyen : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDSCBNBDieuChuyen(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
