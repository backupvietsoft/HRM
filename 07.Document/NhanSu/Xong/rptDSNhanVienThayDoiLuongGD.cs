...
namespace Vs.Report
{
    public partial class rptDSNhanVienThayDoiLuongGD : DevExpress.XtraReports.UI.XtraReport
    {
        public rptDSNhanVienThayDoiLuongGD(DateTime ngayin, DateTime TuNgay, DateTime DenNgay)
        {
