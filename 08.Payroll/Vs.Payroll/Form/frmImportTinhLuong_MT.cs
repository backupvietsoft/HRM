...
{
    public partial class frmImportTinhLuong_MT : DevExpress.XtraEditors.XtraForm
    {
        Point ptChung;
        ...
        private void Import(DataTable dtSource)
        {
            ...
            if (res == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("spImportExportLuong_MT", conn, sTrans);
        ...
        private void frmImportTinhLuong_MT_Load(object sender, EventArgs e)
        {
            if (iloai == 2)
            {
        ...
        private void frmImportTinhLuong_MT_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Close();
        }
