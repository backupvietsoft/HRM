...
{
    public partial class rptBangLSPChiTietMHNgayTheoCN : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBangLSPChiTietMHNgayTheoCN(DateTime tngay, DateTime dngay, DateTime ngayxem)
        {
            ...
            xrTlbltungay.Text = Commons.Modules.ObjLanguages.GetLanguage("rptBangLSPChiTietMHNgayTheoCN", "lblTNgay") + " " + tngay.ToString("dd/MM/yyyy") + " " + Commons.Modules.ObjLanguages.GetLanguage("rptBangLSPChiTietMHNgayTheoCN", "lblDNgay") + " " + dngay.ToString("dd/MM/yyyy");
