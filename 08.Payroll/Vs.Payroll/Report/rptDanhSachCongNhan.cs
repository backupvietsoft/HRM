...
namespace Vs.Report
{
    public partial class rptDanhSachCongNhan : DevExpress.XtraReports.UI.XtraReport
    {
        DateTime ngay;
        DateTime TNgay;
        DateTime DNgay;
        public rptDanhSachCongNhan(DateTime ngayin, DateTime tngay, DateTime dngay)
        {
            ...
            //lb.Text = ngay.ToString("dd/MM/yyyy");
