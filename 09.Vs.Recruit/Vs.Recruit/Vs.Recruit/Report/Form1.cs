...
//                row4_datTuNgayTD.NumberFormat = "MM/dd/yyyy";
...
//                row4_datTuNgayTD.Value2 = Convert.ToDateTime(datTngay.EditValue);
...
//                row4_datDenNgayTuyenDung.NumberFormat = "MM/dd/yyyy";
...
//                row4_datDenNgayTuyenDung.Value2 = Convert.ToDateTime(datTngay.EditValue);
...
//                row4_datNgayPhongVan.NumberFormat = "MM/dd/yyyy";
...
//                row4_datNgayPhongVan.Value2 = Convert.ToDateTime(datTngay.EditValue);
...
//                row4_datBuoiPhongVan.NumberFormat = "MM/dd/yyyy";
...
//                row4_datBuoiPhongVan.Value2 = Convert.ToDateTime(datDNgay.EditValue);
...
//                row4_Sub_TieuDe_BaoCao.Value2 = "Từ ngày " + Convert.ToDateTime(datTngay.EditValue).ToString("dd/MM/yyyy") + "      Đến ngày  " + Convert.ToDateTime(datDNgay.EditValue).ToString("dd/MM/yyyy");
//                return;
//            }
//        }
...
//                cmd.Parameters.Add("@TNgay", SqlDbType.DateTime).Value = Convert.ToDateTime(datTngay.EditValue);
//                cmd.Parameters.Add("@DNgay", SqlDbType.DateTime).Value = Convert.ToDateTime(datDNgay.EditValue);
//                cmd.Parameters.Add("@LOAI_BC", SqlDbType.Int).Value = Convert.ToInt32(spEditIdReport.EditValue);
...
//        {
//            int LoaiBaoCao = Convert.ToInt32(spEditIdReport.EditValue);
//            switch (LoaiBaoCao)
//            {
//                case 1:
//                case 2:
//                case 3:
//                    DSUngVienThamGiaTuyenDung(LoaiBaoCao);
//                    break;
//                case 4:
//                    DSUngVien(LoaiBaoCao);
//                    break;
//            }
//        }
...
//        {
//            //datTngay.EditValue = Convert.ToDateTime("01/07/2022");
//            //datDNgay.EditValue = Convert.ToDateTime("31/07/2022");
//        }
