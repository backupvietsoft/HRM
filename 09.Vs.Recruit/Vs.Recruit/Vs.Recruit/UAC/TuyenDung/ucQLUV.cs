    ...
    public partial class ucQLUV : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ExportUngVien(string sPath)
        {
            try
            {
                ...
                sheet1.Range[1, 30].Comment.RichText.Text = Commons.Modules.ObjSystems.ConvertCombototext(Commons.Modules.ObjSystems.DataLoaiCV(false,-1));
                sheet1.Range[1, 31].Comment.RichText.Text = Commons.Modules.ObjSystems.ConvertCombototext(Commons.Modules.ObjSystems.DataLoaiCV(false,-1));
