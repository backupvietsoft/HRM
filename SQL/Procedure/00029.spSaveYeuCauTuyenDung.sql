...
BEGIN
	...
	BEGIN TRANSACTION INS_Target
		...
		BEGIN
			--thêm
				INSERT INTO dbo.YEU_CAU_TUYEN_DUNG(MA_YCTD,ID_TO,ID_CN,NGAY_YEU_CAU,ID_TT,NGAY_NHAN_DON,GHI_CHU)
				VALUES(@MA_YCTD,@ID_TO,@ID_CN,@NGAY_YEU_CAU,@ID_TT,@NGAY_NHAN_DON,@GHI_CHU)	
				SET @ID_YCTD = SCOPE_IDENTITY()
		END
		ELSE
		BEGIN
				UPDATE dbo.YEU_CAU_TUYEN_DUNG 
				SET ID_TO =@ID_TO,ID_CN =@ID_CN,ID_TT =@ID_TT,NGAY_YEU_CAU =@NGAY_YEU_CAU ,NGAY_NHAN_DON = @NGAY_NHAN_DON,GHI_CHU =@GHI_CHU
